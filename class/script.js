...
class ma_class { // On choisis le nom qu'on veut
  ...
  constructor(variable1, variable2) {
    ...
    this.ce_que_je_veux = variable2; // On crée des variables pour la class entière grâce à "this" qui permet de viser la class.
  }
  ...
  une_fonction_de_ma_class() {
    ...
    document.body.appendChild(nouvelle_balise_p); // j'ajoute au body ma nouvelle balise p
  }
}

var mes_class = []; // Je créer un tableau vide
mes_class.push(new ma_class("blabla","orange")); // Push sert à ajouter à la fin du tableau quelque chose
